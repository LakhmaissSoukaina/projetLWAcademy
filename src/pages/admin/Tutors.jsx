...
function Tutors() {
  ...
  const toggleTutorStatus = (id) => {
    console.log("Toggle tutor status for:", id);
  };

  const removeTutor = (id) => {
    console.log("Remove tutor:", id);
  };
  ...
  return (
    <div className="space-y-6 w-full max-w-full">
      ...
      <footer className="pt-8 border-t border-gray-100 text-center pb-4">
        <p className="text-xs text-gray-400">
          All tutor assignments are subject to Academic Board approval. 
          <a className="text-blue-900 hover:underline ml-1 font-semibold" href="#">View Guidelines</a>
        </p>
      </footer>
    </div>
  );
